...
@ApiStatus.Internal
        companion object {
                val MINT =
                Values("MINT", "mint", Color(r = 100, g = 249, b = 162), 59,
