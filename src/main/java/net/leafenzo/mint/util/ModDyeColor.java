...
public class ModDyeColor {

    // What the heck do I even use here?
    // I need an expandable list that can be treated as an enum, I surely couldn't just instance the DyeColor enum, right?
    // Maybe I can... that would be the easiest solution, I should start with that and hope it works.

//    <DyeColor> VALUES = new ArrayList<DyeColor>();
...
//    }
    ...
    public DyeColor registerDyeColor(Identifier identifier, int color, MapColor mapColor, int fireworkColor, int signColor) {
