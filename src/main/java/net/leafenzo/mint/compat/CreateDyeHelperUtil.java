...
public class CreateDyeHelperUtil {

    public static Map<DyeColor, Couple<Integer>> appendToDyeTable(Map<DyeColor, Couple<Integer>> original) {
        ImmutableMap.Builder<DyeColor, Couple<Integer>> builder = new ImmutableMap.Builder<DyeColor, Couple<Integer>>();
        return builder.putAll(original.entrySet())
