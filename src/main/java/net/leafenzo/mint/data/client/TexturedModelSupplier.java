...
public class TexturedModelSupplier extends SimpleModelSupplier {
    ...
    public TexturedModelSupplier addTexture(String textureName, Identifier id) {
        this.textures.put(textureName, id);
        return this;
    }

    public TexturedModelSupplier setRenderType(RenderLayer renderLayer) {
