...
public class ElsDyeModRegistryHelper {
    public static class ItemRegistry {
        ...
        public static final HashMap<DyeItem, TagKey<Item>> DYE_ITEM_TAG_FROM_DYE_ITEM = new HashMap<DyeItem, TagKey<Item>>(); static {
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.WHITE_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.WHITE_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.ORANGE_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.ORANGE_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.MAGENTA_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.MAGENTA_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.LIGHT_BLUE_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.LIGHT_BLUE_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.YELLOW_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.YELLOW_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.LIME_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.LIME_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.PINK_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.PINK_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.GRAY_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.GRAY_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.LIGHT_GRAY_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.LIGHT_GRAY_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.CYAN_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.CYAN_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.PURPLE_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.PURPLE_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.BLUE_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.BLUE_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.BROWN_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.BROWN_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.GREEN_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.GREEN_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.RED_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.RED_DYE));
            DYE_ITEM_TAG_FROM_DYE_ITEM.put((DyeItem) Items.BLACK_DYE, ElsDyeModTags.Items.getOrCreateDyeItemCommonTag((DyeItem) Items.BLACK_DYE));
        }
...
//    public static final ArrayList<Item> DYED_PAPER_ITEMS = new ArrayList<Item>();
        ...
        public static Item registerItem(String name, Item item) {
            return Registry.register(Registries.ITEM, new Identifier(ElsDyeMod.MOD_ID, name), item);
        }
...
//     */ public static final ArrayList<Block> FUNCTIONAL_BLOCKS = new ArrayList<Block>();
        ...
        public static Block registerBlock(String name, Block block) {
            ...
            return Registry.register(Registries.BLOCK, new Identifier(ElsDyeMod.MOD_ID, name), block);
        }
        ...
        private static Item registerBlockItem(String name, Block block) {
            ...
            return Registry.register(Registries.ITEM, new Identifier(ElsDyeMod.MOD_ID, name), blockItem);
        }
