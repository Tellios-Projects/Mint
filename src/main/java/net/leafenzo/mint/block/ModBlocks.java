...
public class ModBlocks {
    ...
    public static final Block MINT_CANDLE_CAKE = Blocks.register("mint_candle_cake", new CandleCakeBlock(MINT_CANDLE, AbstractBlock.Settings.copy(Blocks.CANDLE_CAKE)));
