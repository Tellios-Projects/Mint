 ...
 */
public class ElsDyeModBlockEntityType<T extends BlockEntity> {
...
//            ).build()
//    );
    public static void RegisterModBlockEntityTypes() { ElsDyeModInit.LOGGER.debug("Registering mod blockEntityTypes for " + ElsDyeMod.MOD_ID);}
}
