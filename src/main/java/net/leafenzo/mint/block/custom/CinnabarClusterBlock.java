...
public class CinnabarClusterBlock extends Block implements Waterloggable {
    ...
    public CinnabarClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
        super(settings);
